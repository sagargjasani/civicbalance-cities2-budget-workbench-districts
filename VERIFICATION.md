# Verification plan — Cities: Skylines II

Status: NOT RUN. There is no executable implementation to test.

## Module acceptance criteria

### 1. District budget scenarios

- [ ] Define a versioned input fixture specifically for district budget scenarios.
...
### 2. Service capacity sheets

- [ ] Define a versioned input fixture specifically for service capacity sheets.
- [ ] Document the expected output and units before implementation.
- [ ] Test valid, missing, malformed, and unsupported-version inputs.
- [ ] Repeat with the same fixture and compare results.
- [ ] Confirm that source files and unrelated settings remain unchanged.

### 3. City snapshot comparisons

- [ ] Define a versioned input fixture specifically for city snapshot comparisons.
- [ ] Document the expected output and units before implementation.
- [ ] Test valid, missing, malformed, and unsupported-version inputs.
- [ ] Repeat with the same fixture and compare results.
- [ ] Confirm that source files and unrelated settings remain unchanged.
